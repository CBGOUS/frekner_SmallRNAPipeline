...
public class StepBSMapCalcMethRatios extends NGSStep{
    ...
    public StepBSMapCalcMethRatios(){
    }
     ...
     * 
     */
    public StepBSMapCalcMethRatios(InputDataForStep sid){
    ...
    public String shortStepDescription(){
      return "calculate methylation ratios for alignment files generated by the BSMap mapping step";
    }
    ...
    public void parseConfigurationData(HashMap configData) throws Exception{
        ...
        */
        ...
        if(configData.get(ID_REF_GENOME)==null) {
            logger.info("<" + configData.get(ID_REF_GENOME) + "> : Missing Definition in Configuration File");
            logger.error("<" + configData.get(ID_REF_GENOME) + "> : Missing Definition in Configuration File");
        ...
        */
        ...
        while (itSD.hasNext()){
            try{
                ...
                logger.info("error executing methratio program:\n" + ex.toString());
                logger.error("error executing methratio program:\n" + ex.toString());
    ...
    public void verifyInputData() throws IOException{
        ...
        if(new File(this.getPathToMethRatioPy()).exists() == false){
            logger.info("methratio.py not found at location < " + this.getPathToMethRatioPy() +">");
            logger.error("methratio.py not found at location < " + this.getPathToMethRatioPy() +">");
        ...
        for(SampleDataEntry sampleData: this.getStepInputData().getSampleData()){
            ...
            if (!correctExt){
                logger.info(STEP_ID_STRING + ": incorrect file extension for input alignment file <" 
                  + alnFile + ">. should have <" + INFILE_EXTENSION + "> as extension");
                logger.error(STEP_ID_STRING + ": incorrect file extension for input alignment file <" 
                  + alnFile + ">. should have <" + INFILE_EXTENSION + "> as extension");
            ...
            if (new File(alnFile).exists()==false){
                logger.error(STEP_ID_STRING + ": input alignment file <" + alnFile + "> does not exist");
